...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_REC]   = LAYOUT_default(
	    	   _______,                _______,    _______, _______,    _______, _______, _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    
                   ...
                   _______,    TG(_REC),   _______,    _______, REC_CLR,    _______, _______, _______,    _______,    _______,    _______,    _______,                _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______ ,
                   _______,    REC_ARM,    REC_STOP,   _______, _______,    _______, _______, _______,    _______,    _______,    _______,    _______,    	      _______,                                        _______,    _______,    _______,    
                   _______,                _______,    _______, _______,    _______, _______, _______,    _______,    _______,    _______,    _______,    _______,    _______,                _______,                _______,    _______,    _______,    _______ ,
                   _______,    _______,    _______,                                  _______,                                     _______,    _______,    _______,    _______,    REC_RET,    _______,    REC_ADV,                _______,    _______ 
	      ),
};
