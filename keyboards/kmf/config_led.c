...
led_config_t g_led_config = { {
  ...
  {  91,     92,  93,NO_LED,NO_LED,NO_LED,94, NO_LED,NO_LED,NO_LED,95,     96,     97,     98,     99,    100,    101,      NO_LED,102,    103, NO_LED }
    ...
    { 1 *12, 33 }, { 2 *12, 33 }, { 3 *12, 33 }, { 4 *12, 33 }, { 5 *12,  33 }, { 6 *12,  33 }, { 7 *12,  33 }, { 8 *12, 33 }, { 9 *12,  33 }, { 10*12, 33 }, { 11*12, 33 }, { 12*12, 33 }, { 13*12, 33 }, /************/ /************/ /************/ /************/ { 18*12, 33 }, { 19*12, 33 }, { 20*12, 33 }, /************/
    { 1 *12, 44 }, /************/ { 3 *12, 44 }, { 4 *12, 44 }, { 5 *12,  44 }, { 6 *12,  44 }, { 7 *12,  44 }, { 8 *12, 44 }, { 9 *12,  44 }, { 10*12, 44 }, { 11*12, 44 }, { 12*12, 44 }, { 13*12, 44 }, /************/ /************/ { 16*12, 44 }, /************/ { 18*12, 44 }, { 19*12, 44 }, { 20*12, 44 }, { 21*12, 44 },
